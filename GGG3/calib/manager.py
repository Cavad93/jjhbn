...
class OnlineCalibManager:
    def __init__(self):
        ...
        self.roll_buf = []
        self.roll_y = []
        self.holdout_mgr = HoldoutCalibManager()  # НОВОЕ
        self.roll_hours = int(os.getenv("CALIB_ROLLING_H","72"))  # ИЗМЕНЕНО: было 48
        self.min_n = int(os.getenv("CALIB_MIN_N","200"))  # ИЗМЕНЕНО: было 300
