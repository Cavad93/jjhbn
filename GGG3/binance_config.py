...
phase_memory_cap = 15000  # Максимум примеров на каждую фазу рынка (0-5)
# Итого: 15,000 × 6 фаз = 90,000 примеров ≈ 32 MB
# Период: ~24-36 месяцев торговли при 10 позициях
#
# ВАРИАНТЫ:
#   3,000  - дефолт (риск переобучения, но актуальные данные)
#  10,000  - минимум (6-12 месяцев)
#  15,000  - сбалансированный (1-2 года) ✅ РЕКОМЕНДОВАНО
#  30,000  - консервативный (2-4 года)
#  50,000  - максимальная генерализация (4-6 лет)
